CFLAGS_OPT := -DXASH_CSDM -O3 -fomit-frame-pointer -ggdb -funsafe-math-optimizations -ftree-vectorize -fgraphite-identity -floop-interchange -floop-block -funsafe-loop-optimizations -finline-limit=1024
...
XASH3D_CONFIG := $(APPLICATIONMK_PATH)/csdm_config.mk

APP_ABI := x86 armeabi-v7a-hard armeabi
APP_MODULES := client server yapb
